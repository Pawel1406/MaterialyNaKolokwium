package RozbudowaneStrukturyJava.SerweryWielowatkowe.Kolokwium2025Okienkowo.Serwer;
...
public class Serwer {
    ...
    private void startDuel(ClientHandler challenger, ClientHandler challengee){
        ...
        duel.setOnEnd(()->{
            ...
            //do wersji okienkowej, do konsoli, trzeba zakomentować
            challenger.printAllUsersResult(database.getLeaderboard());
